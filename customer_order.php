...
// オーダー数量
$orderQuantity = $lotNo * $orderLot; 
$priceAmount = $cifPrice * $orderQuantity;
...
<body>
    <!-- form作成 -->
    <form method="POST" action="customer_order_finish.php">
        <div class>
            <fieldset>
                <legend>Offer Detail</legend>
                    ...
                    <br>
                    <label>Order Quantity：<?php echo $orderQuantity; ?>mt</label><br>
                    <label>Price Amount：<?php echo $priceAmount; ?>USD</label><br>
                    
                    <!-- hidden -->
                    <input type="hidden" name="id" value=<?php echo $id ?> >
                    <input type="hidden" name="orderQuantity" value=<?php echo $orderQuantity ?> >
                    <input type="hidden" name="priceAmount" value=<?php echo $priceAmount?> >
